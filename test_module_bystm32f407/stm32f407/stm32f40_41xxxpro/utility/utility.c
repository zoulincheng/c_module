...
// acc: 0x0000 or 0xffff
u_short crc16_block(const u_char *data, u_long len, u_short acc)
{
  while(len--)
  {
...
u_short CRC16_U(const u_char *pciDat,u_long dwiLen)
{
	return crc16_block(pciDat, dwiLen, 0xffff);
}
